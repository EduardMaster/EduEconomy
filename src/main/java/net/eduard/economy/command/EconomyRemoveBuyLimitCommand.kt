...
class EconomyRemoveBuyLimitCommand : CommandManager("removebuylimit",  "removerlimitedecompra") {
    init {
        usage = "/money removebuylimit <player> <limit>"
        description = "Remover Limite de Compra do jogador"
    }
    override fun command(sender: CommandSender, args: Array<String>) {
        ...
        sender.sendMessage(
            EduEconomyPlugin.instance.message("buy-limit-remove")
